...
aura_agent = Agent(
    ...
    instructions=(
        ...
        "4. Một số quy tắc trong sách tự mâu thuẫn với nhau (sách ghi nhiều dị bản, có 'luu_y' về sự "
        "mâu thuẫn). Khi gặp trường hợp này, hãy nói rõ sự mâu thuẫn thay vì chọn đại một bên.\n"
        "5. Luôn trích dẫn quy tắc/số trang nguồn (source_page) mà bạn dùng để trả lời, để người dùng "
        "có thể tra lại.\n"
